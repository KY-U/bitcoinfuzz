...
// on both sides of the FFI; see sp_lib's diverges_on_intermediate_zero_sum.
#define BDK_SP_SKIP "SKIP_INTERMEDIATE_ZERO_SUM"
...
// "LABEL_FAIL" rejection sentinel, BDK_SP_SKIP for the known upstream
// divergence, or null if the arguments themselves are malformed.
extern "C" char *
bdk_sp_create_outputs(const uint8_t *outpoint36, const uint8_t *input_seckeys,
...
extern "C" void bdk_sp_free_string(void *ptr);
